...
class VideoSink(object) :
    ...
    vsnk = VideoSink('mymovie.avi',size=(1000,500),colorspace='y8',rate=1, codec="lavc")
    for i in range(1000):
    ...
    """
    def __init__( self, filename='output.avi', size=(512,512), rate=25, colorspace='rgb24',codec_family='lavc', vcodec="ffvhuff"):
